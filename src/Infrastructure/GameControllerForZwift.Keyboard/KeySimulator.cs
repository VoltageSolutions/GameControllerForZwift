...
namespace GameControllerForZwift.Keyboard
{
    public class KeySimulator
    {
        ...
        public void PerformAction(ZwiftFunction zwiftFunction, ZwiftPlayerView playerView = ZwiftPlayerView.Default, ZwiftRiderAction riderAction = ZwiftRiderAction.WaveHand)
        {
                ...
                case ZwiftFunction.AdjustCameraAngle:
                    switch (playerView)
                    {
                        ...
                        case ZwiftPlayerView.Drone:
                            ...
                            break;
                        default:
                            throw new ArgumentOutOfRangeException(nameof(playerView), playerView, null);
                    }
                    break;
                ...
                case ZwiftFunction.RiderAction:
                    switch (riderAction)
                    {
                        ...
                        case ZwiftRiderAction.ScreenShot:
                            ...
                            break;
                        default:
                            throw new ArgumentOutOfRangeException(nameof(riderAction), riderAction, null);
                    }
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(zwiftFunction), zwiftFunction, null);
            }
        }
    }
}
