...
namespace GameControllerForZwift.WPF.Logging
{
    public class CustomMessageEventLogLoggerProvider : ILoggerProvider
    {
        ...
        {
            return new CustomEventLogger(_eventLog, categoryName);
        }
        ...
        private class CustomEventLogger : ILogger
        {
            #region Fields
            ...
            public CustomEventLogger(EventLog eventLog, string categoryName)
            {
                _eventLog = eventLog;
